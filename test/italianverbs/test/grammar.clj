...
(def agreement-test-1
  (is (= (let [result (first (over s-aux (over noun-phrase "la" "melanzana") (over vp-aux "essere" (over vp-past "essere" "nero"))))]
           (get-italian-1 (get-in result '(:italian))))
