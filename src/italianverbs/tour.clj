...
(defn accent-characters [language]
  (cond (= language "it")
        [:div.accents
         [:button.accented {:onclick "add_a_grave('" language "');"} "&agrave;"]
         [:button.accented {:onclick "add_e_grave('" language "');"} "&egrave;"]
         [:button.accented {:onclick "add_o_grave('" language "');"} "&ograve;"]
         ]
        (= language "es")
        [:div.accents
